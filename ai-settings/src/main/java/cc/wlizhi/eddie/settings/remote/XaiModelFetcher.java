 ...
 * }
 * </pre>
 * 文档：<a href="https://docs.x.ai">https://docs.x.ai</a>
 */
@Component
public class XaiModelFetcher implements RemoteModelFetcher {
    ...
    private List<ModelVO> parseResponse(String json) {
        try {
            ...
            throw new RuntimeException("解析 xAI 远程模型列表返回数据失败: " + e.getMessage(), e);
        }
    }
}
