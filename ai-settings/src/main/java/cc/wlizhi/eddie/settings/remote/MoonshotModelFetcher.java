 ...
 *   "object": "list",
 *   "data": [
 *     { "id": "kimi-k2.5", "object": "model", "created": 1234567890, "owned_by": "moonshot" }
 *   ]
 * }
 * </pre>
 * 文档：<a href="https://platform.moonshot.cn/docs">https://platform.moonshot.cn/docs</a>
 */
@Component
public class MoonshotModelFetcher implements RemoteModelFetcher {
    ...
    private List<ModelVO> parseResponse(String json) {
        try {
            ...
            throw new RuntimeException("解析 Moonshot 远程模型列表返回数据失败: " + e.getMessage(), e);
        }
    }
}
