 ...
 * 零一万物远程模型获取器
 * <p>
 * 零一万物 API 兼容 OpenAI 格式：
 * <pre>
 * GET {baseUrl}/models
 * {
 *   "object": "list",
 *   "data": [
 *     { "id": "yi-lightning", "object": "model", "owned_by": "lingyi" }
 *   ]
 * }
 * </pre>
 * 文档：<a href="https://platform.lingyiwanwu.com/docs">https://platform.lingyiwanwu.com/docs</a>
 */
@Component
public class LingyiModelFetcher implements RemoteModelFetcher {
    ...
    private List<ModelVO> parseResponse(String json) {
        try {
            ...
            throw new RuntimeException("解析零一万物远程模型列表返回数据失败: " + e.getMessage(), e);
        }
    }
}
