 ...
 * }
 * </pre>
 * 文档：<a href="https://docs.mistral.ai">https://docs.mistral.ai</a>
 */
@Component
public class MistralModelFetcher implements RemoteModelFetcher {
    ...
    private List<ModelVO> parseResponse(String json) {
        try {
            ...
            throw new RuntimeException("解析 Mistral 远程模型列表返回数据失败: " + e.getMessage(), e);
        }
    }
}
