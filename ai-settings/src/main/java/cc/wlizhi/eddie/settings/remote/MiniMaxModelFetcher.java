 ...
 * }
 * </pre>
 * 文档：<a href="https://platform.minimaxi.com/document">https://platform.minimaxi.com/document</a>
 */
@Component
public class MiniMaxModelFetcher implements RemoteModelFetcher {
    ...
    private List<ModelVO> parseResponse(String json) {
        try {
            ...
            throw new RuntimeException("解析 MiniMax 远程模型列表返回数据失败: " + e.getMessage(), e);
        }
    }
}
