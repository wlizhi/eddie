...
@Component
public class AgentChatClientFactoryRouter {

    @Resource
    private List<AgentChatClientFactory> factories;

    @Resource
    private AgentChatClientFactory defaultChatClientFactory;
     ...
     */
    public AgentChatClientFactory resolve(String providerCode) {
