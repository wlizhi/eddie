...
function getCopyHtml(theme, text, textEscaped, fontSize) {
    ...
    <div class="dev-section">
        ...
        <div class="dev-title">复制功能开发中</div>
        <div class="dev-desc">该功能正在开发中，敬请期待后续版本更新</div>
    </div>
</div>`;
    return getLayoutHtml(theme, '<svg width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="4.5" width="7" height="7" rx=".8"/><path d="M2.5 10.5v-7a1 1 0 0 1 1-1h7"/></svg> 复制', body, fontSize);
}

module.exports = {getCopyHtml};
